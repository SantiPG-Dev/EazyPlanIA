...
public class RoleTest {
    ...
    public void testRoleTypes() {
        assertNotNull(com.eazyplan.ia.domain.entities.Role.class);
        
        // Verificar que existen los tipos de roles definidos en la entidad
        assertTrue(com.eazyplan.ia.domain.entities.Role.RoleType.values().length >= 3);
        
        System.out.println("Roles disponibles: " + java.util.Arrays.toString(
            com.eazyplan.ia.domain.entities.Role.RoleType.values()));
    }

    @Test
    public void testRoleCreation() {
        var role = new com.eazyplan.ia.domain.entities.Role();
        
        // Crear rol con tipo USER (por defecto)
        assertNotNull(role);
        
        System.out.println("Rol creado correctamente: " + 
            com.eazyplan.ia.domain.entities.Role.RoleType.values()[0]);
    }

    @Test
    public void testRoleWithUser() {
        // Verificar que Role se puede usar en relación con User
        var user = new com.eazyplan.ia.domain.entities.User();
        assertNotNull(user);
