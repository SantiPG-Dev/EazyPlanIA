...
public class DietServiceTest {
    ...
    public void testCalculateMacrosBalanced() {
        com.eazyplan.domain.services.DietService dietService = DietService.get();
        
        var macros = dietService.calculateMacros(com.eazyplan.domain.entities.Diet.DietType.BALANCED, 2000f);
    ...
    public void testCalculateMacrosLowCarbs() {
        ...
        var macros = dietService.calculateMacros(com.eazyplan.domain.entities.Diet.DietType.LOW_CARBS, 1500f);
    ...
    public void testCalculateMacrosHighProtein() {
        ...
        var macros = dietService.calculateMacros(com.eazyplan.domain.entities.Diet.DietType.HIGH_PROTEIN, 2500f);
    ...
    public void testCalculateMacrosKeto() {
        ...
        var macros = dietService.calculateMacros(com.eazyplan.domain.entities.Diet.DietType.KETO, 1800f);
    ...
    public void testCalculateMacrosVegan() {
        ...
        var macros = dietService.calculateMacros(com.eazyplan.domain.entities.Diet.DietType.VEGAN, 2000f);
    ...
    public void testCalculateMacrosCustom() {
        ...
        var macros = dietService.calculateMacros(com.eazyplan.domain.entities.Diet.DietType.CUSTOM, 2000f);
    ...
    public void testCreateDietWithUserService() {
        ...
        com.eazyplan.domain.entities.Diet diet = new com.eazyplan.domain.entities.Diet();
    ...
    public void testUpdateDiet() {
        ...
        var diet = new com.eazyplan.domain.entities.Diet("Test", 
            com.eazyplan.domain.entities.Diet.DietType.BALANCED, java.time.LocalDate.now(), 2000f, 600f, 800f, 600f, 3000f);
        
        DietService.get().createDiet(diet, userService, user.getId());
        
        // Actualizar dieta
        var updated = diet;
        if (updated.getDietType() == null) updated.setDietType(com.eazyplan.domain.entities.Diet.DietType.LOW_CARBS);
        
        DietService.get().updateDiet(diet, "Actualizada", null, 
            com.eazyplan.domain.entities.Diet.DietType.LOW_CARBS, 1500f, 600f, 300f, 600f, 2000f);
    ...
    public void testGetUserDiets() {
        ...
        // Crear varias dietas
        for (int i = 0; i < 3; i++) {
            com.eazyplan.domain.entities.DietType type = 
                com.eazyplan.domain.entities.Diet.DietType.values()[i % com.eazyplan.domain.entities.Diet.DietType.values().length];
            var diet = new com.eazyplan.domain.entities.Diet("Diet " + (i+1), type, java.time.LocalDate.now(), 2000f, 600f, 800f, 600f, 3000f);
            DietService.get().createDiet(diet, userService, user.getId());
        }
